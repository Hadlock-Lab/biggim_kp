...
def load_nodes_data(data_folder):
    folder_path = os.path.join(data_folder, 'biggim_gene_nodes.csv')
...
def load_file(file_path):
    with open(file_path) as f:
        ...
        reader = csv.reader(f, delimiter=',')
        disease_abbr = file_path.split('/')[-1].split('_')[2]
        ...
        for line in reader:
            ...
            predicate = {
                ...
                "provided_by": "Multiomics Provider: Big GIM I",
                "provenance": "https://github.com/NCATSTranslator/Translator-All/wiki/Big-GIM-I",
                "N": int(line[2]),
            ...
            yield {
                "_id": '-'.join([line[0], line[1], line[2], line[3], line[4]]),
                "subject": subject,
                "predicate": predicate,
                "object": object_
            }
...
def load_data(data_folder):
    ...
    folder_path = os.path.join(data_folder, "BigGIM_coexpression*")
